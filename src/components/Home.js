...
function Home(){
    ...
    const getNotes = async()=>{
        await axios.get(`https://simplenote-vu7f.onrender.com/notes-api/get-notes/${user.userObj.email}`)
        .then((result)=>{
    ...
    const deleteNote = async(title)=>{
      let res = await axios.delete(`https://simplenote-vu7f.onrender.com/notes-api/remove-notes/${user.userObj.email}/${title}`)
